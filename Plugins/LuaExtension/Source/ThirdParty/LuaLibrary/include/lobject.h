...
/*
** Get the actual string (array of bytes) from a 'TLuaString'. (Generic
...
/* get string length from 'TLuaString *s' */
#define tsslen(s)  \
...
typedef struct Upvaldesc {
  TLuaString *name;  /* upvalue name (for debug information) */
...
typedef struct Proto {
  ...
  TLuaString  *source;  /* used for debug information */
  GCObject *gclist;
} Proto;
