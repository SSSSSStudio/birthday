...
enum
{
	TW2_WRITER_BINARY = 0x01,
	TW2_WRITER_APPEND = 0x02,
	TW2_WRITER_CHANGE = 0x04,
};
...
typedef struct tw2_io_vtable_s
{
	tw2_archive_t*	(*createReader)(const char*);
...
tw2_API void tw2_io_reset_file_functions(const tw2_io_vtable_t* pVtable);
