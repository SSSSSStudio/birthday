...
struct FCookAdvancedOptions
{
	...
	FORCEINLINE const TMap<UClass*, int32>& GetOverrideNumberOfAssetsPerFrame() const
	{
		return OverrideNumberOfAssetsPerFrame;
	}
...
public:
	...
	FORCEINLINE virtual TArray<FPlatformExternAssets>& GetAddExternAssetsToPlatform() override
	{
	...
	FORCEINLINE TArray<FString> GetUnrealPakCommandletOptions() const
	{
		return GetUnrealPakSettings().UnrealCommandletOptions;
	}
	...
	static FString GetPakCommandsSaveToPath(const FString& InSaveAbsPath, const FString& InPlatfornName,
	                                        const FHotPatcherVersion& InVersion);
...
public:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "BaseVersion",
		meta = (RelativeToGameContentDir, EditCondition="bByBaseVersion"))
	...
	// }
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "External Files",
		meta=(EditCondition = "bIncludePakVersionFile"))
	...
	FString GetChunkSavedDir(const FString& InVersionId, const FString& InBaseVersionId, const FString& InChunkName,
...
struct HOTPATCHERRUNTIME_API FReplacePakRegular
{
	...
	FReplacePakRegular(const FString& InVersionId, const FString& InBaseVersionId, const FString& InChunkName,
