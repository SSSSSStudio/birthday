...
namespace UnLua
{
    ...
    TSharedPtr<ITypeInterface> FPropertyRegistry::GetFieldProperty(UField* Field)
    {
        ...
        {
            UECodeGen_Private::FEnumPropertyParams Params;
            Params.NameUTF8 = nullptr;
            Params.Offset = 0;
            Params.ObjectFlags = RF_Transient;
            Params.PropertyFlags = CPF_HasGetValueTypeHash;
            //const auto EnumProperty1 = new FEnumProperty(PropertyCollector, NAME_None, RF_Transient, 0, CPF_HasGetValueTypeHash, Enum);
